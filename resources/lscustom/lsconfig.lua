...
------Window tint------
	windowtint = {
		{ name = "Pure Black", tint = 1, price = 6500},
		{ name = "Darksmoke", tint = 2, price = 4700},
		{ name = "Lightsmoke", tint = 3, price = 3200},
		{ name = "Limo", tint = 4, price = 2100},
		{ name = "Green", tint = 5, price = 750},
	},
...
------Neon layout------
	neonlayout = {
		{name = "Front,Back and Sides", price = 3400},
	},
	--Neon color
	neoncolor = {
...
----Wheel accessories----
	wheelaccessories = {
		...
		{ name = "Bulletproof Tires", price = 32000},
...
---------Headlights---------
	[22] = {
		...
		{name = "Xenon Lights", mod = 1, price = 1200},
	},
...
-----------Armor-------------
	[16] = {
		{name = "Armor Upgrade 20%",modtype = 16, mod = 0, price = 4500},
		{name = "Armor Upgrade 40%",modtype = 16, mod = 1, price = 9000},
		{name = "Armor Upgrade 60%",modtype = 16, mod = 2, price = 14000},
		{name = "Armor Upgrade 80%",modtype = 16, mod = 3, price = 25000},
		{name = "Armor Upgrade 100%",modtype = 16, mod = 4, price = 50000},
	},

---------Suspension-----------
	[15] = {
		{name = "Lowered Suspension",mod = 0, price = 2300},
		{name = "Street Suspension",mod = 1, price = 6000},
		{name = "Sport Suspension",mod = 2, price = 7500},
		{name = "Competition Suspension",mod = 3, price = 9000},
	},
...
----------Transmission---------
	[13] = {
		{name = "Street Transmission", mod = 0, price = 30000},
		{name = "Sports Transmission", mod = 1, price = 35000},
...
------------Engine----------
	[11] = {
		{name = "Engine Upgrade, Level 2", mod = 0, price = 25000},
		{name = "Engine Upgrade, Level 3", mod = 1, price = 32000},
		{name = "Engine Upgrade, Level 4", mod = 2, price = 45000},
	},
