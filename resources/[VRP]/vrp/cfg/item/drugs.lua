...
items["cocaleaves"] = {"Coca Leaves","Used for making coco."}
items["benzoilmetilecgonina"] = {"Benzoilmetilecgonina","Used for making coco."}
items["cleancoca"] = {"Clean Cocaine","Given to Children."}
