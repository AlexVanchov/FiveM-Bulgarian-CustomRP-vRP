...
local nike = {model = "ig_bankman"}
local dh = {model = "a_m_y_dhill_01"}
...
cfg.cloakroom_types = {
  ...
  ["prison"] = {
	...
	["nike"] = {
    _config = { not_uniform = true },
    ["Minecraft Costplay"] = nike,
    ["Downhill Costplay"] = dh
    },
   ["emergency"] = {
...
cfg.cloakrooms = {
  ...
  {"prison", 474.9143371582,-985.84649658204,24.914766311646}, 
  ...
  --{"surgery",1149.7332763672,-643.63024902344,56.767879486084},----first spawn change skin
  ...
  {"nike",71.219230651855,-1387.8620605469,29.37607383728},
