...
local blips = {
	...
	--441.71017456055,-1011.4605102539,30.988317489624
    {name=blipNameFuel, id=361, x=441.710, y=-1011.460, z=30.988},
...
station = {
	...
	--441.94509887695,-1014.2817382813,28.639764785767
    {x=-441.967,y=-1014.317,z=28.639,s=34}, -- police custom
}
...
stationsText[34] = {x=-441.967,y=-1014.317,z=28.639,s=34}
